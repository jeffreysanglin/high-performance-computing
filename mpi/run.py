...
from distance_py import knn_py, get_rank #euc_distance, cos_sim
...
cpp_scrs, cpp_indxs = knn_py(X, Y, k, False)
...
c_time = timeit(lambda: knn_py(X, Y, k, False), number=num_evaluations)
